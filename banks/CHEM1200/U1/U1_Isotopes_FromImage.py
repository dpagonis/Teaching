...
def generate_question():
    ...
    question_options = [
        'What isotope is shown in the figure below<<br>{img};answers',
        'Name the isotope shown below:<br>{img};answers',
        'Give the element and isotope of this nucleus:<br>{img};answers'
    ]
    ...
    answers = f'{mass_num}{symbol};{mass_num} {symbol}' #using symbol, with and without space
    answers += f';{name_upper}-{mass_num};{name_upper} {mass_num}' #uppercase element (Carbon-12, Carbon 12)
    answers += f';{name_lower}-{mass_num};{name_lower} {mass_num}' #lowercase element (carbon-12, carbon 12)
    print(answers)
