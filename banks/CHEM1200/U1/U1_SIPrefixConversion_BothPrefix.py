...
def generate_question():
    ...
    question_options = [
        'Convert {v1_str} {prefix1}{unit} to {prefix2}{unit};v2.answers()',
        'Convert {v2_str} {prefix2}{unit} to {prefix1}{unit};v1.answers()'
    ]
    ...
    v1 = sf(f'1e{power}',sig_figs=1,units_str=(prefix1+unit))
    v2 = v1.convert_to((prefix2+unit))
